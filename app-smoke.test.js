...
// O eixo Y deve usar vários degraus e uma escala monetária mais precisa.
assert.match(elements.chart.innerHTML, /R\$ 1,1 mi/);
assert.equal(elements.chart.innerHTML.match(/<line class="grid-line"/g).length, 12);
